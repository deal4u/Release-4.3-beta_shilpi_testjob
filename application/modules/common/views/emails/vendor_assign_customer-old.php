                                        ...
                                        <tr>
                                            <td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
                                                ...
                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px; width: 100%;">
                                                    ...
                                                    <br>
                                                    Dear Customer, your claim# <?php echo $claim_num; ?> for <?php echo $item; ?> has been assigned to vendor.
                                                    <br><br>
                                                    Vendor details are:
                                                    <br>
                                                    <legend><b style="color: #777777;">Comapany:</b> </legend> <?php echo $vendor['company']; ?><br>
                                                    <legend><b style="color: #777777;">Email:</b> </legend> <?php echo $vendor['email']; ?><br>
                                                    <legend><b style="color: #777777;">Contact:</b> </legend> <?php echo $vendor['phone']; ?><br>
