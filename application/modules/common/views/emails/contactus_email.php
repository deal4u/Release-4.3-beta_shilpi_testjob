                                        ...
                                        <tr>
                                            <td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px; width: 100%;">
                                                    <br>
                                                    <legend><b style="color: #777777;"> Contact Us, </b> </legend>
                                                    <br>
                                                    Inquiry Mail.
                                                    <br><br>
                                                    Customer details are:
                                                    <br>
                                                    <legend><b style="color: #777777;">Customer Name:</b> </legend> <?php echo $full_name ?><br>
                                                    <legend><b style="color: #777777;">Email:</b> </legend> <?php echo $email_address ?><br>
                                                    <legend><b style="color: #777777;">Contact No:</b> </legend> <?php echo $phone_no ?><br>
                                                    <legend><b style="color: #777777;">Company:</b> </legend> <?php echo $company ?><br>
                                                    <legend><b style="color: #777777;">Address:</b> </legend> <?php echo $home_address.', '.$home_city.', '.$home_state.', '.$home_zip; ?><br>

                                                    <legend><b style="color: #777777;">Comments:</b> </legend> <?php echo $comment ?><br>
