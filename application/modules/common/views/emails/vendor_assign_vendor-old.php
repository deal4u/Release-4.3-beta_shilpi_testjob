                                        ...
                                        <tr>
                                            <td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px; width: 100%;">
                                                    ...
                                                    <br>
                                                    Dear Vendor, New assignment has been added for you.
                                                    <br><br>
                                                    Customer details are:
                                                    <br>
                                                    <legend><b style="color: #777777;">Customer Name:</b> </legend> <?php echo $customer['first_name'].' '.$customer['last_name']; ?><br>
                                                    <legend><b style="color: #777777;">Email:</b> </legend> <?php echo $customer['email']; ?><br>
                                                    <legend><b style="color: #777777;">Contact:</b> </legend> <?php echo $customer['home_phone']; ?><br>
                                                    <legend><b style="color: #777777;">Address:</b> </legend> <?php echo $customer['city'].' '.$customer['state'].', '.$customer['zip_code']; ?><br>
