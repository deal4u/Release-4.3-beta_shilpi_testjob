                                        ...
                                        <tr>
                                            <td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px; width: 100%;">
                                                    <br>
                                                    <legend><b style="color: #777777;"> Welcome To Affiliate Program, </b> </legend>
                                                    <br><br>
                                                    Customer details are:
                                                    <br>
                                                    <legend><b style="color: #777777;">Name:</b> </legend> <?php echo $first_name.' '.$last_name; ?><br>
                                                    <legend><b style="color: #777777;">Email:</b> </legend> <?php echo $email;?><br>
                                                    <legend><b style="color: #777777;">Contact No:</b> </legend> <?php echo $phone; ?><br>
                                                    <legend><b style="color: #777777;">Fax No:</b> </legend> <?php echo $fax; ?><br>
                                                    <legend><b style="color: #777777;">Company:</b> </legend> <?php echo $company; ?><br>
                                                    <legend><b style="color: #777777;">Address:</b> </legend> <?php echo $address.', '.$city.', '.$state.', '.$zip_code; ?><br>

                                                    <hr style="margin-top: 10px; margin-bottom: 10px;">
                                                    <br>
                                                    <p> If you have any further questions please contact us at <a href="mailto:<?php echo support_email(); ?>"><?php echo support_email(); ?></a> </p>
                                                    <br>
                                                    <p> Thanks,<br>
                                                        CompleteCare Home Warranty</p>
