                        ...
                        <div class="ibox m-0">
                            <div class="ibox-content ibox-content pt-4 pb-2">
                                <div class="filter_tasks">
                                    <form role="form" class="form" id="filter_tasks"  method="GET" action="<?php echo admin_url(); ?>invoice/search_customer_invoice">
                                        <div class="row">
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    <label>First Name</label>
                                                    <input type="text" class="form-control" name="first_name" value="<?php echo @$param['first_name']; ?>" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    <label>Last Name</label>
                                                    <input type="text" class="form-control" name="last_name" value="<?php echo @$param['last_name']; ?>" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="customer_status">
                                                        ...
                                                        <option value="1" <?php if(@$param['customer_status']){ if ($param['customer_status']==1){ ?> selected <?php } } ?>>Active</option>
                                                        <option value="2" <?php if(@$param['customer_status']){ if ($param['customer_status']==2){ ?> selected <?php } } ?>>InActive</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-12">
                            ...
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTables-example tbl tbl_tasks">
                                        ...
                                        <tbody>
                                        <?php foreach($invoice_data as $customer_invoice) {?>
                                            <tr id="<?php echo $customer_invoice['id']; ?>">
                                                <td>
                                                    <div class="i-checks"><label> <input type="checkbox" class="check" name="claim_status" value="<?php echo $customer_invoice['id']; ?>"> <i></i> </label></div>
                                                </td>
                                                <td><?php echo db_date($customer_invoice['created_at']); ?></td>
                                                <td><?php $claim_data = get_claim_data($customer_invoice['claim']);
                                                ...
                                                <td>
                                                    <?php echo $get_customer_detail['first_name']." ".$get_customer_detail['last_name']; ?>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <select class="form-control change_auth_net" name="auth_net">
                                                            <option value="1" <?php if ($customer_invoice['auth_net']==1){ ?> selected <?php } ?>>Net 15</option>
                                                            <option value="2" <?php if ($customer_invoice['auth_net']==2){ ?> selected <?php } ?>>Net 30</option>
                                                            <option value="3" <?php if ($customer_invoice['auth_net']==3){ ?> selected <?php } ?>>Net 45</option>
                                                        </select>
                                                    </div>
                                                </td>
                                                <td><?php echo get_invoice_type($customer_invoice['type']); ?></td>
                                                <td><?php echo '$'.number_format((float)$customer_invoice['amount'], 2, '.', ''); ?></td>
                                                <td>
                                                    <select class="form-control change_status" name="status">
                                                        <option selected disabled>Status</option>
                                                        <option value="1" <?php if ($customer_invoice['status']==1){ ?> selected <?php } ?>>New</option>
                                                        <option value="2" <?php if ($customer_invoice['status']==2){ ?> selected <?php } ?>>Rejected</option>
                                                        <option value="3" <?php if ($customer_invoice['status']==3){ ?> selected <?php } ?>>Approved</option>
                                                    </select>
                                                </td>
                                            </tr>
                                        <?php } ?>
...
<script type="text/javascript">
    $(document).ready( function () {
        ...
        $('.change_status').on('change',function(){
            ...
            $.ajax({
                type: "POST",
                url:'<?php echo admin_url(); ?>invoice/update_customer_invoice_status',
                dataType: "json",
        ...
        $('.change_all_status').on('change',function(){
            ...
            if (i==0){
                ...
                $.ajax({
                    url:'<?php echo admin_url(); ?>invoice/update_customer_multipe_invoice',
                    type: 'POST',
