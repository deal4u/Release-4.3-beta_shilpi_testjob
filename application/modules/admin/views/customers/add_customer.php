                                        ...
                                        <div class="ibox-content ibox-content pt-4 pb-2">
                                            <div class="row">
                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="s_person">
                                            ...
                                            <div class="left_section">
                                                ...
                                                <?php if (get_session('admin_type') == 1 || (get_session('admin_type') == 2 && get_session('admin_permissions')['miscellaneous'] != 'N/A' && isset(get_session('admin_permissions')['miscellaneous']->add_coverage))) {
													...
													if(isset($details['policy_num'])){
													$policydata = get_customer_policies($details['policy_num']);												
													$coverage = get_coverage($details['id'],$policydata[0]['id']); 
													
													foreach($coverage as $cov){$cover[] =  $cov['coverage'];} }	?>
                                                    <div class="form_section">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="i-checks ml-3">
                                                                            <label>
                                                                                ...
                                                                                <input <?php  if(isset($cover) && in_array($coverage['meta_key'],$cover)){ echo "checked = 'checked'";} ?> type="checkbox" class="opt-coverage"  value="<?php echo $coverage['meta_key']; ?>" data-val="<?php echo $coverage['meta_value']; ?>" data-id="<?php echo $coverage['meta_content']; ?>"name="opt_coverage"  >
                                                                                <i class="mr-2"></i>
                                                        ...
                                                        <table class="table table-borderless opt-table">
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
																	...
																	<?php if(isset($details['id']) && $details['id']!=""){
																		 $latest_policy = get_customer_policy($details['policy_num']);
																		 foreach (get_coverage($details['id'], $latest_policy['id']) as $cov_id){
            ...
            $.ajax({
                ...
                success:function(status){
                    if(status.msg=='success'){
						...
						btn.ladda('stop');
                        if(status.customer_id!="" && typeof(status.customer_id)!= 'undefined' ){
