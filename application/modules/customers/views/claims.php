                                        ...
                                        <div class="ibox-content ibox-content pt-4 pb-2">
                                            <div class="left_section">
                                                <form method="post" id="save-claim">
                                                   <input type="hidden" name="customer" class="form-control select-customer" value="<?php echo @$id; ?>"> 
...
<script>
    $(document).ready(function () {
        ...
        $('#save-claim').submit(function (e) {
            ...
            $.ajax({
                url:base_url+'customers/claims/save',
                type:'post',
                data:value,
                dataType:'json',
                processData: false,
                ...
                success:function(status){
                    if(status.msg=='success'){
                        ...
                        setTimeout(function () {
							 window.history.back();
                          //  $(location).attr('href',  base_url+"customers/claims/claim_status");
                        }, 2000);
                    }
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            url:  base_url+'customers/claims/get_claim_item_covered',
            type: 'POST',
            data: {id : id},
            dataType:'json',
            cache: false,
