...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" method="post" action="<?php echo base_url(); ?>customers/login/login_verify">
               ...
               <a href="<?php echo base_url(); ?>customers/forgot_password"><small>Forgot password?</small></a>
