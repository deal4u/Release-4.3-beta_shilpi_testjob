                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            <div class="change_pass middle-box animated fadeInDown" style="margin-top: 0px">
...
<script src="<?php echo base_url(); ?>assets/admin_assets/js/jquery.validate.min.js"
...
<script type="text/javascript">
    ...
    $('#submit').click(function(e){
        ...
        if($("#change_password_form").valid()){
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>customers/update_password',
                type:'post',
                data:value,
                dataType:'json',
